...
## Hierarchy Rule — Hit Network UI Design Skills

| Skill | Role |
|-------|------|
| **website-design** | PRIMARY — full-stack builds, architecture + deployment gates. Use for anything with a backend, DeFi, or complex frontend. |
| **frontend-design-ultimate** (this skill) | SECONDARY — high-visual static sites only. Always routes through website-design's deployment gate before going live. |
| **superdesign** | REFERENCE ONLY — design guidelines. Not a builder. |

**When using this skill for Hit Network:** Apply all website-design deployment and approval gates before pushing anything live. This skill generates the UI. website-design governs the deploy.
