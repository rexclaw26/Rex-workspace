...
**This skill is REFERENCE ONLY for Hit Network builds.**

| Skill | Role |
|-------|------|
| **website-design** | PRIMARY — full-stack builds, architecture + deployment gates |
| **frontend-design-ultimate** | SECONDARY — high-visual static sites |
| **superdesign** (this skill) | REFERENCE ONLY — design guidelines, theme systems, component patterns |

**Do not use this skill to generate production code for Hit Network.** Use it to define visual direction, color systems, and component patterns — then execute with website-design or frontend-design-ultimate which carry the proper gates and approval flows.
